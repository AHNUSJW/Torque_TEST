...
namespace Model
{
    ...
    public enum REG : UInt16
    {
        ...
        REG_WR_SCREWORDER0      = 0x0500 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER1      = 0x0501 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER2      = 0x0502 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER3      = 0x0503 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER4      = 0x0504 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER5      = 0x0505 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER6      = 0x0506 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER7      = 0x0507 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER8      = 0x0508 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER9      = 0x0509 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER10     = 0x050A + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER11     = 0x050B + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER12     = 0x050C + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER13     = 0x050D + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER14     = 0x050E + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER15     = 0x050F + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER16     = 0x0510 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER17     = 0x0511 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER18     = 0x0512 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER19     = 0x0513 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER20     = 0x0514 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER21     = 0x0515 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER22     = 0x0516 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER23     = 0x0517 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER24     = 0x0518 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER25     = 0x0519 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER26     = 0x051A + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER27     = 0x051B + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER28     = 0x051C + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER29     = 0x051D + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER30     = 0x051E + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER31     = 0x051F + ADDROFFSET.TQ_XH_ADDR,   //

        REG_WR_SCREWORDER48     = 0x0530 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER64     = 0x0540 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER80     = 0x0550 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER96     = 0x0560 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER112    = 0x0570 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER128    = 0x0580 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER144    = 0x0590 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER160    = 0x05A0 + ADDROFFSET.TQ_XH_ADDR,   //
        REG_WR_SCREWORDER176    = 0x05B0 + ADDROFFSET.TQ_XH_ADDR,   //
