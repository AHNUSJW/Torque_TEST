        ...
        public void Protocool_Sequence_SendCOM(TASKS meTask)
        {
            ...
            switch (meTask)
            {
                case TASKS.REG_BLOCK4_CAL:
                    ...
                    meTXD[idx++] = 0x00;
                    meTXD[idx++] = (byte)MyDevice.mXF[sAddress].devc.unit;
                    meTXD[idx++] = 0x00;
                    ...
                    meTXD[idx++] = MyDevice.myUIT.B1;
                    meTXD[idx++] = MyDevice.myUIT.B0;
                    MyDevice.myUIT.I = MyDevice.mXF[sAddress].devc.torque_over[(byte)MyDevice.mXF[sAddress].devc.unit];
                    meTXD[idx++] = MyDevice.myUIT.B3;
                    meTXD[idx++] = MyDevice.myUIT.B2;
                    meTXD[idx++] = MyDevice.myUIT.B1;
                    meTXD[idx++] = MyDevice.myUIT.B0;
                ...
                case TASKS.REG_BLOCK2_PARA:
                    ...
                    meTXD[idx++] = 0x00;
                    meTXD[idx++] = MyDevice.mXF[sAddress].para.wifimode;
                    meTXD[idx++] = 0x00;
                ...
                case TASKS.REG_BLOCK3_SCREW1:
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        ...
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                        MyDevice.myUIT.UI = (uint)(MyDevice.mXF[sAddress].screw[i].scw_ticketSerial & 0xFFFFFFFF);
                        meTXD[idx++] = MyDevice.myUIT.B3;
                        meTXD[idx++] = MyDevice.myUIT.B2;
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                ...
                case TASKS.REG_BLOCK3_SCREW2:
                    ...
                    for (int i = 8; i < 16; i++)
                    {
                        ...
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                        MyDevice.myUIT.UI = (uint)(MyDevice.mXF[sAddress].screw[i].scw_ticketSerial & 0xFFFF);
                        meTXD[idx++] = MyDevice.myUIT.B3;
                        meTXD[idx++] = MyDevice.myUIT.B2;
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
        ...
        private void mePort_DataReceiveRead()
        {
            ...
            switch (trTASK)
            {
                ...
                case TASKS.REG_BLOCK4_CAL:
                    if (len == 0x85)
                    {
                        MyDevice.mXF[sAddress].devc.unit = (UNIT)mePort_GetUInt16(3);
                        ...
                        //四个备用字节
                        MyDevice.mXF[sAddress].devc.capacity      = mePort_GetInt32(15);
                        MyDevice.mXF[sAddress].devc.ad_zero       = mePort_GetInt32(19);
                        MyDevice.mXF[sAddress].devc.ad_pos_point1 = mePort_GetInt32(23);
                        MyDevice.mXF[sAddress].devc.ad_pos_point2 = mePort_GetInt32(27);
                        MyDevice.mXF[sAddress].devc.ad_pos_point3 = mePort_GetInt32(31);
                        MyDevice.mXF[sAddress].devc.ad_pos_point4 = mePort_GetInt32(35);
                        MyDevice.mXF[sAddress].devc.ad_pos_point5 = mePort_GetInt32(39);
                        MyDevice.mXF[sAddress].devc.ad_neg_point1 = mePort_GetInt32(43);
                        MyDevice.mXF[sAddress].devc.ad_neg_point2 = mePort_GetInt32(47);
                        MyDevice.mXF[sAddress].devc.ad_neg_point3 = mePort_GetInt32(51);
                        MyDevice.mXF[sAddress].devc.ad_neg_point4 = mePort_GetInt32(55);
                        MyDevice.mXF[sAddress].devc.ad_neg_point5 = mePort_GetInt32(59);
                        MyDevice.mXF[sAddress].devc.tq_pos_point1 = mePort_GetInt32(63);
                        MyDevice.mXF[sAddress].devc.tq_pos_point2 = mePort_GetInt32(67);
                        MyDevice.mXF[sAddress].devc.tq_pos_point3 = mePort_GetInt32(71);
                        MyDevice.mXF[sAddress].devc.tq_pos_point4 = mePort_GetInt32(75);
                        MyDevice.mXF[sAddress].devc.tq_pos_point5 = mePort_GetInt32(79);
                        MyDevice.mXF[sAddress].devc.tq_neg_point1 = mePort_GetInt32(83);
                        MyDevice.mXF[sAddress].devc.tq_neg_point2 = mePort_GetInt32(87);
                        MyDevice.mXF[sAddress].devc.tq_neg_point3 = mePort_GetInt32(91);
                        MyDevice.mXF[sAddress].devc.tq_neg_point4 = mePort_GetInt32(95);
                        MyDevice.mXF[sAddress].devc.tq_neg_point5 = mePort_GetInt32(99);
                        MyDevice.mXF[sAddress].devc.torque_disp   = mePort_GetInt32(103);
                        MyDevice.mXF[sAddress].devc.torque_min    = mePort_GetInt32(107);
                        MyDevice.mXF[sAddress].devc.torque_max    = mePort_GetInt32(111);
                        MyDevice.mXF[sAddress].devc.torque_over[(int)MyDevice.mXF[sAddress].devc.unit] = mePort_GetInt32(115);

                        //更新超量程使用扭矩值——超量程以over作为基准，无论标定单位是什么这个基准均是3600
                        switch (MyDevice.mXF[sAddress].devc.unit)
                        {
                            case UNIT.UNIT_nm:
                                MyDevice.mXF[sAddress].devc.torque_over[0] = mePort_GetInt32(115);
                            ...
                            case UNIT.UNIT_lbfin:
                                ...
                                MyDevice.mXF[sAddress].devc.torque_over[1] = mePort_GetInt32(115);
                            ...
                            case UNIT.UNIT_lbfft:
                                ...
                                MyDevice.mXF[sAddress].devc.torque_over[2] = mePort_GetInt32(115);
                            ...
                            case UNIT.UNIT_kgcm:
                                ...
                                MyDevice.mXF[sAddress].devc.torque_over[3] = mePort_GetInt32(115);
                            ...
                            case UNIT.UNIT_kgm:
                                ...
                                MyDevice.mXF[sAddress].devc.torque_over[4] = mePort_GetInt32(115);
                                break;
                            default:
                                break;
                        }
                ...
                case TASKS.REG_BLOCK3_WLAN:
                    if (len == 0x65)
                    {
                        MyDevice.mXF[sAddress].wlan.rf_chan = mePort_GetByte(4);
                        MyDevice.mXF[sAddress].wlan.rf_option = mePort_GetByte(6);
                        MyDevice.mXF[sAddress].wlan.rf_para = mePort_GetByte(8);
                        MyDevice.mXF[sAddress].wlan.rs485_baud = mePort_GetByte(10);
                        MyDevice.mXF[sAddress].wlan.rs485_stopbit = mePort_GetByte(12);
                        MyDevice.mXF[sAddress].wlan.rs485_parity = mePort_GetByte(14);
                        MyDevice.mXF[sAddress].wlan.wf_ssid = "";
                        MyDevice.mXF[sAddress].wlan.wf_pwd = "";
                        //wf_ssid 32个字节，以BEM46示例， 字节显示为 00 42 00 45 00 4D 00 34 00 36 ... 00
                        for (int i = 0; i < 16; i++)
                        {
                            ...
                            {
                                MyDevice.mXF[sAddress].wlan.wf_ssid += (char)mePort_GetByte((ushort)(35 + i * 2 + 1));
                            }
                        }
                        //wf_pwd 32个字节
                        for (int i = 0; i < 16; i++)
                        {
                            ...
                            {
                                MyDevice.mXF[sAddress].wlan.wf_pwd += (char)mePort_GetByte((ushort)(67 + i * 2 + 1));
                            }
                        }
                ...
                case TASKS.REG_BLOCK1_ID:
                    if (len == 0x25)
                    {
                        ...
                        MyDevice.mXF[sAddress].wlan.wf_ip = $"{mePort_GetByte(8):X2}{mePort_GetByte(10):X2}{mePort_GetByte(12):X2}{mePort_GetByte(14):X2}";
                        MyDevice.mXF[sAddress].wlan.wf_port = Convert.ToUInt32(mePort_GetByte(15)) << 8 | Convert.ToUInt32(mePort_GetByte(16)); //两个字节分别位于高低位拼成Uint32
                        mePort_DataRemove(0x25);
                        isEQ = true;
                    }
                    else
                ...
                case TASKS.REG_BLOCK2_PARA:
                    if (len == 0x45)
                    {
                        ...
                        MyDevice.mXF[sAddress].para.wifimode      = mePort_GetByte(32);
                        MyDevice.mXF[sAddress].para.timeoff       = mePort_GetByte(34);
                        MyDevice.mXF[sAddress].para.timeback      = mePort_GetByte(36);
                        MyDevice.mXF[sAddress].para.timezero      = mePort_GetByte(38);
                        MyDevice.mXF[sAddress].para.disptype      = mePort_GetByte(40);
                        MyDevice.mXF[sAddress].para.disptheme     = mePort_GetByte(42);
                        MyDevice.mXF[sAddress].para.displan       = mePort_GetByte(44);
                        MyDevice.mXF[sAddress].para.unhook        = mePort_GetUInt16(45);
                        MyDevice.mXF[sAddress].para.adspeed       = mePort_GetByte(48);
                        MyDevice.mXF[sAddress].para.autozero      = (AUTOZERO)mePort_GetByte(50);
                        MyDevice.mXF[sAddress].para.trackzero     = (TRACKZERO)mePort_GetByte(52);
                        MyDevice.mXF[sAddress].para.angcorr       = mePort_GetFloat(55);
                        MyDevice.mXF[sAddress].para.amenable      = mePort_GetUInt16(59);
                        MyDevice.mXF[sAddress].para.screwmax      = mePort_GetByte(62);
                        MyDevice.mXF[sAddress].para.runmode       = mePort_GetByte(64);
                ...
                case TASKS.REG_BLOCK1_HEART:
                    if (len == 0x25)
                    {
                        MyDevice.mXF[sAddress].data[0].torque = mePort_GetInt32(3);
                        MyDevice.mXF[sAddress].data[0].torseries_pk = mePort_GetInt32(7);
                        MyDevice.mXF[sAddress].data[0].angle = mePort_GetInt32(11);
                        MyDevice.mXF[sAddress].data[0].angle_acc = mePort_GetInt32(15);
                        MyDevice.mXF[sAddress].data[0].update = Convert.ToBoolean(mePort_GetInt16(19));
                        MyDevice.mXF[sAddress].data[0].error = Convert.ToBoolean(mePort_GetInt16(21));
                        MyDevice.mXF[sAddress].data[0].battery = mePort_GetByte(24);
                        MyDevice.mXF[sAddress].data[0].keybuf = mePort_GetByte(26);
                        mePort_DataRemove(0x25);
                        isEQ = true;
                    }
                    else
        ...
        private void mePort_DataReceiveWrite()
        {
            ...
            switch ((REG)mePort_GetUInt16(2))
            {
                ...
                case REG.REG_W_MEMABLE:
                    ...
                    break;
                case REG.REG_WR_BLUETOOTH_UNBIND:
                    if (mePort_GetInt16(4) == 0x0001)
                    {
                        //写命令的参数值是角色权限
                        isEQ = true;
                        mePort_DataRemove(8);
