            ...
            switch (meTask)
            {
                ...
                case TASKS.REG_BLOCK3_SCREW1:
                    ...
                    for (int i = 0; i < 8; i++)
                    {
                        ...
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                        MyDevice.myUIT.UI = (uint)(MyDevice.mRS[sAddress].screw[i].scw_ticketSerial & 0xFFFFFFFF);
                        meTXD[idx++] = MyDevice.myUIT.B3;
                        meTXD[idx++] = MyDevice.myUIT.B2;
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                ...
                case TASKS.REG_BLOCK3_SCREW2:
                    ...
                    for (int i = 8; i < 16; i++)
                    {
                        ...
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
                        MyDevice.myUIT.UI = (uint)(MyDevice.mRS[sAddress].screw[i].scw_ticketSerial & 0xFFFF);
                        meTXD[idx++] = MyDevice.myUIT.B3;
                        meTXD[idx++] = MyDevice.myUIT.B2;
                        meTXD[idx++] = MyDevice.myUIT.B1;
                        meTXD[idx++] = MyDevice.myUIT.B0;
